...
export default function DarkModToggle() {
  ...
  return (
    <button
      ...
      className="cursor-pointer select-none outline-none w-fit h-fit  fixed right-10 top-10 before:w-2 before:h-2  before:z-2 before:absolute before:bg-green-400 before:left-[-4px] before:rounded-full"
    >
      <img
        src={DarkLightImg}
        alt="DarkLightImg"
